...
#SBATCH --job-name=load_imbalance
...
# srun --mpi=pmi2 python3 /home/mfa51/service-capacity/load_imbalance.py
source /home/mfa51/service-capacity-virtualenv/bin/activate
python3 /home/mfa51/service-capacity/load_imbalance.py
